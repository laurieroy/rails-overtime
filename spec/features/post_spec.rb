...
describe 'navigate' do
	...
	describe 'new' do
		it 'has a link from the homepage' do
			employee = Employee.create(first_name: "Employee", last_name: "Employee", 
	...
	describe 'delete' do
		it 'can be deleted' do
			...
			post_to_delete = Post.create(date: Date.today, rationale: "doesn't matter", user_id: delete_user.id, overtime_request: 2.0)
	...
	describe 'edit' do
		...
		it 'cannot be edited by a non-authorized user' do
			logout(:user)
			nonauthorized_user = FactoryBot.create(:nonauthorized_user)
			login_as(nonauthorized_user, :scope => :user)

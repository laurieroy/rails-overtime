...
RSpec.describe AuditLog, type: :model do
  ...
  describe "validations" do
    it 'it should be required to have an user assocation' do
    ...
    it 'it should always have a start_date' do
      @audit_log.start_date = nil
      expect(@audit_log).to_not be_valid
    end

    it 'it should always have a start_date equal to 6 days prior' do
